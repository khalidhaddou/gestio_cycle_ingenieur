    ...
    <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col col-lg-9 col-xl-7">
                  <div class="card">
                    <form action="{{url('admin/Enseignant', $admin->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    <div class="rounded-top  d-flex flex-row" style="background-color: #efefef; height:200px">
                      <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                          ...
                          style="width: 150px; z-index: 1">
                            <span class="d-none d-sm-block"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-camera-fill text-black mx-5 text-primary " viewBox="0 0 16 16">
                      ...
                      <div class="mb-5">
                        ...
                        <div class="cord-footer">
                            <div class="mt-2  text-center">
                                ...
                                <a href="{{url('admin/Enseignant')}}" class="btn btn-warning">Annuler</a>
                              </div>
                          </div>
                      </div>
                    </form>
