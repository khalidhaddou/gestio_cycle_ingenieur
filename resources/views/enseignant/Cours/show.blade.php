            ...
            <div class="col-md-6 col-lg-4 mb-3 my-2">
                <div class="card ">
                   ...
                   <div class="card-footer text-white">
                    ...
                    <button class="btn btn-secondary editbtnCours "  value="{{$item->id}}" data-bs-toggle="modal" data-bs-target="#modalCours"  >
                   ...
                   <div class="modal fade" id="exampleModal{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form action="{{ url('/enseignant/Cours' . '/' . $item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    <div class="modal fade" id="modalCours" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <form action="{{ url('/enseignant/Cours' ,$item->id) }}"  method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
            <div class="modal-body">
              <div class="row">
                <input class="form-control  w-100 ml-10" id="id" hidden
                type="text" />
                <div class="col mb-3">
