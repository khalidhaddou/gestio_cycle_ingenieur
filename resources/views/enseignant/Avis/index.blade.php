...
<div class="content-wrapper">
    ...
    <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          ...
          <div class="modal-body">
            <form Action="{{url('/enseignant/Avis')}}" Method="POST" enctype="multipart/form-data">
               @csrf
            <div class="row">
              <div class="col mb-3">
                <label for="nameWithTitle" class="form-label">Titre</label>
                <input
                    type="text"
                    id="nameWithTitle"
                    class="form-control"
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row mb-5 my-3">
          @foreach($AvisEns as $item)
            <div class="col-md-6 col-lg-4 mb-3">
              <div class="card h-100">
                <div class="card-body">
                    <h5 class="card-title">Titre : {{$item->titre}} </h5>
                    <h6 class="card-subtitle text-muted">Publier par : {{$item->nom}}</h6>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div class="text-center">
                      ...
                      <a class="btn btn-danger "  data-bs-toggle="modal" data-bs-target="#exampleModal{{$item->id}}"   role="button" >
                      ...
                      <div class="modal fade" id="exampleModal{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <form action="{{ url('/enseignant/Avis' . '/' . $item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                            <div class="modal-body">
  ...
  <div class="modal fade" id="modalModifier{{$item->id}}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      ...
      <div class="modal-body">
        <form action="{{ url('/enseignant/Avis' ,$item->id) }}"  method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
           <div class="row">
          <div class="col mb-3">
