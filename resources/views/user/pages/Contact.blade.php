    ...
    <div class="container-fluid py-3 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h1 class="fw-bold text-primary text-uppercase">Contactez-Nous</h1>
                <h3 class="mb-0">Si vous avez des questions, n'hésitez pas à nous contacter</h3>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">+212 611223344</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Notre email pour poser des question</h5>
                            <h4 class="text-primary mb-0">gi.fste@gmail.com</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Adresse de l'établissement</h5>
                            <h4 class="text-primary mb-0">BP 509 Boutalamine, Errachidia</h4>
                        </div>
                    </div>
                </div>
            </div>
